...
export const CASES = [
  ...
  { group: 'react', id: 'controlled-time', title: '3 · Controlled time (timeMs)', anchor: '3--controlled-time-time--timems',
    summary: 'A slider drives timeMs; the component renders that exact frame.' },
  ...
  { group: 'vue', id: 'autoplay',        title: '1 · Autoplay', anchor: '1--autoplay',
    summary: 'The component honours the document\'s own trigger.' },
  { group: 'vue', id: 'controlled-time', title: '2 · Controlled time (timeMs)', anchor: '2--controlled-time-time--timems',
    summary: 'A slider drives timeMs; the component renders that exact frame.' },
